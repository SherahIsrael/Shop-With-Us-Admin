        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          ...
          <div className="md:grid md:grid-cols-3 gap-8">
            ...
            <FormField control={form.control} name="price" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" disabled={loading} placeholder="5.78" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField control={form.control} name="isFeatured" render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 mt-1">
                  <FormControl>
                    <Checkbox className="mt-2" checked={field.value} // @ts-ignore 
            ...
            /><FormField control={form.control} name="isArchived" render={({ field }) => (
              <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 mt-1">
                ...
                <div>
                  ...
                  <FormDescription>
                    This product will ont appear anywhere on the store
                  </FormDescription>
                </div>
              </FormItem>
            )}
